...
func (uc *UserCreate) SetNillableCreationDate(t *time.Time) *UserCreate {
	if t != nil {
		uc.SetCreationDate(*t)
	}
	return uc
}
...
func (uc *UserCreate) SetEmailValid(b bool) *UserCreate {
	uc.mutation.SetEmailValid(b)
	return uc
}

// SetNillableEmailValid sets the "EmailValid" field if the given value is not nil.
func (uc *UserCreate) SetNillableEmailValid(b *bool) *UserCreate {
	if b != nil {
		uc.SetEmailValid(*b)
	}
	return uc
...
func (uc *UserCreate) SetConfig(s *schema.Config) *UserCreate {
...
func (uc *UserCreate) AddBlockIDs(ids ...uuid.UUID) *UserCreate {
	uc.mutation.AddBlockIDs(ids...)
	return uc
}

// AddBlocks adds the "blocks" edges to the Block entity.
func (uc *UserCreate) AddBlocks(b ...*Block) *UserCreate {
...
func (uc *UserCreate) defaults() {
	if _, ok := uc.mutation.CreationDate(); !ok {
		v := user.DefaultCreationDate()
		uc.mutation.SetCreationDate(v)
	}
	if _, ok := uc.mutation.EmailValid(); !ok {
		v := user.DefaultEmailValid
		uc.mutation.SetEmailValid(v)
	}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.CreationDate(); !ok {
		return &ValidationError{Name: "creationDate", err: errors.New(`ent: missing required field "User.creationDate"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.CreationDate(); ok {
		_spec.SetField(user.FieldCreationDate, field.TypeTime, value)
	...
	if value, ok := uc.mutation.EmailValid(); ok {
		_spec.SetField(user.FieldEmailValid, field.TypeBool, value)
		_node.EmailValid = value
	}
	...
	if nodes := uc.mutation.BlocksIDs(); len(nodes) > 0 {
