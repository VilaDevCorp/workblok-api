...
func (tu *TaskUpdate) SetActivityID(id uuid.UUID) *TaskUpdate {
	tu.mutation.SetActivityID(id)
	return tu
}

// SetActivity sets the "activity" edge to the Activity entity.
func (tu *TaskUpdate) SetActivity(a *Activity) *TaskUpdate {
...
func (tu *TaskUpdate) ClearActivity() *TaskUpdate {
...
func (tu *TaskUpdate) check() error {
	if _, ok := tu.mutation.ActivityID(); tu.mutation.ActivityCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Task.activity"`)
	}
...
// SetActivityID sets the "activity" edge to the Activity entity by ID.
func (tuo *TaskUpdateOne) SetActivityID(id uuid.UUID) *TaskUpdateOne {
	tuo.mutation.SetActivityID(id)
	return tuo
}

// SetActivity sets the "activity" edge to the Activity entity.
func (tuo *TaskUpdateOne) SetActivity(a *Activity) *TaskUpdateOne {
...
// ClearActivity clears the "activity" edge to the Activity entity.
func (tuo *TaskUpdateOne) ClearActivity() *TaskUpdateOne {
